...
import 'cp_pagamento_model.dart';
export 'cp_pagamento_model.dart';

class CpPagamentoWidget extends StatefulWidget {
  const CpPagamentoWidget({super.key});

  @override
  State<CpPagamentoWidget> createState() => _CpPagamentoWidgetState();
}

class _CpPagamentoWidgetState extends State<CpPagamentoWidget>
    with TickerProviderStateMixin {
  late CpPagamentoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => CpPagamentoModel());
