...
import 'a_p_p_a_g_cp_cadastro_model.dart';
export 'a_p_p_a_g_cp_cadastro_model.dart';

class APPAGCpCadastroWidget extends StatefulWidget {
  const APPAGCpCadastroWidget({super.key});

  @override
  State<APPAGCpCadastroWidget> createState() => _APPAGCpCadastroWidgetState();
}

class _APPAGCpCadastroWidgetState extends State<APPAGCpCadastroWidget>
    with TickerProviderStateMixin {
  late APPAGCpCadastroModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => APPAGCpCadastroModel());
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      if ((FFAppState().varTblCAdastro.idPlanoPreco == null) ||
        ...
        context.goNamed(APPAGHomePageWidget.routeName);
                                                ...
                                                onTap: () async {
                                                  if ((kDebugMode == true) ||
                                                    ...
                                                    safeSetState(() {
                                                      _model.textFieldEmailTextController
                                                              ?.text =
                                                          'testeheron${FFAppState().varcontadorteste.toString()}@testex.com';
                                                    });
                                                    safeSetState(() {
                                                      _model.textFieldConfEmailTextController
                                                              ?.text =
