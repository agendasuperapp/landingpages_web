...
import 'a_p_p_f_i_n_cp_bloco06_precos_model.dart';
export 'a_p_p_f_i_n_cp_bloco06_precos_model.dart';

class APPFINCpBloco06PrecosWidget extends StatefulWidget {
  const APPFINCpBloco06PrecosWidget({super.key});

  @override
  State<APPFINCpBloco06PrecosWidget> createState() =>
      _APPFINCpBloco06PrecosWidgetState();
}

class _APPFINCpBloco06PrecosWidgetState
    extends State<APPFINCpBloco06PrecosWidget> with TickerProviderStateMixin {
  late APPFINCpBloco06PrecosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => APPFINCpBloco06PrecosModel());
                        ...
                        Builder(
                          builder: (context) {
                            ...
                            return Flex(
                              ...
                              children: List.generate(varTblPlanos.length,
                                  (varTblPlanosIndex) {
