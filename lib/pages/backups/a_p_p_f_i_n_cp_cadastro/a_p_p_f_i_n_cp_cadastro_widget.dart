...
import 'a_p_p_f_i_n_cp_cadastro_model.dart';
export 'a_p_p_f_i_n_cp_cadastro_model.dart';

class APPFINCpCadastroWidget extends StatefulWidget {
  const APPFINCpCadastroWidget({super.key});

  @override
  State<APPFINCpCadastroWidget> createState() => _APPFINCpCadastroWidgetState();
}

class _APPFINCpCadastroWidgetState extends State<APPFINCpCadastroWidget>
    with TickerProviderStateMixin {
  late APPFINCpCadastroModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => APPFINCpCadastroModel());
