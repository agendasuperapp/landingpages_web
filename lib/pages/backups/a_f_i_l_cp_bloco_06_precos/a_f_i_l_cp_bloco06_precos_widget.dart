...
import 'a_f_i_l_cp_bloco06_precos_model.dart';
export 'a_f_i_l_cp_bloco06_precos_model.dart';

class AFILCpBloco06PrecosWidget extends StatefulWidget {
  const AFILCpBloco06PrecosWidget({super.key});

  @override
  State<AFILCpBloco06PrecosWidget> createState() =>
      _AFILCpBloco06PrecosWidgetState();
}

class _AFILCpBloco06PrecosWidgetState extends State<AFILCpBloco06PrecosWidget>
    with TickerProviderStateMixin {
  late AFILCpBloco06PrecosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AFILCpBloco06PrecosModel());
