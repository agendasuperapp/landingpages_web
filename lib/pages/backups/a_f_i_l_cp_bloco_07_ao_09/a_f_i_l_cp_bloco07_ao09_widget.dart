...
import 'a_f_i_l_cp_bloco07_ao09_model.dart';
export 'a_f_i_l_cp_bloco07_ao09_model.dart';

class AFILCpBloco07Ao09Widget extends StatefulWidget {
  const AFILCpBloco07Ao09Widget({super.key});

  @override
  State<AFILCpBloco07Ao09Widget> createState() =>
      _AFILCpBloco07Ao09WidgetState();
}

class _AFILCpBloco07Ao09WidgetState extends State<AFILCpBloco07Ao09Widget>
    with TickerProviderStateMixin {
  late AFILCpBloco07Ao09Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AFILCpBloco07Ao09Model());
