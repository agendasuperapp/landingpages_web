...
import 'a_p_p_a_g_cp_bloco06_precos_model.dart';
export 'a_p_p_a_g_cp_bloco06_precos_model.dart';

class APPAGCpBloco06PrecosWidget extends StatefulWidget {
  const APPAGCpBloco06PrecosWidget({super.key});

  @override
  State<APPAGCpBloco06PrecosWidget> createState() =>
      _APPAGCpBloco06PrecosWidgetState();
}

class _APPAGCpBloco06PrecosWidgetState extends State<APPAGCpBloco06PrecosWidget>
    with TickerProviderStateMixin {
  late APPAGCpBloco06PrecosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => APPAGCpBloco06PrecosModel());
