...
import 'a_p_p_a_g_cp_bloco07_ao09_model.dart';
export 'a_p_p_a_g_cp_bloco07_ao09_model.dart';

class APPAGCpBloco07Ao09Widget extends StatefulWidget {
  const APPAGCpBloco07Ao09Widget({super.key});

  @override
  State<APPAGCpBloco07Ao09Widget> createState() =>
      _APPAGCpBloco07Ao09WidgetState();
}

class _APPAGCpBloco07Ao09WidgetState extends State<APPAGCpBloco07Ao09Widget>
    with TickerProviderStateMixin {
  late APPAGCpBloco07Ao09Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => APPAGCpBloco07Ao09Model());
