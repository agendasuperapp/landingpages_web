...
import 'a_p_p_f_i_n_cp_pagamento_model.dart';
export 'a_p_p_f_i_n_cp_pagamento_model.dart';

class APPFINCpPagamentoWidget extends StatefulWidget {
  const APPFINCpPagamentoWidget({super.key});

  @override
  State<APPFINCpPagamentoWidget> createState() =>
      _APPFINCpPagamentoWidgetState();
}

class _APPFINCpPagamentoWidgetState extends State<APPFINCpPagamentoWidget>
    with TickerProviderStateMixin {
  late APPFINCpPagamentoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => APPFINCpPagamentoModel());
