...
set "html=webArquivosNecessariosLandPgAPPAfiliado\index.html"
...
xcopy /E /Y /I "webArquivosNecessariosLandPgAPPAfiliado\*" "web\"
...
set "arquivo=buildWeb%versao%\web\LandingPage-rendarecorrente.app-versao%versao%.txt"
